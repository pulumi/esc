...
func TestListEnvironmentTags(t *testing.T) {
	t.Run("OK", func(t *testing.T) {
		...
		assert.Equal(t, expectedTag.Created.GoString(), tag.Created.GoString())
		assert.Equal(t, expectedTag.Modified.GoString(), tag.Modified.GoString())
...
func TestCreateEnvironmentTags(t *testing.T) {
	t.Run("OK", func(t *testing.T) {
		...
		assert.Equal(t, expectedTag.Created.GoString(), val.Created.GoString())
		assert.Equal(t, expectedTag.Modified.GoString(), val.Modified.GoString())
