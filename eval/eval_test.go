...
func (errorProvider) Open(ctx context.Context, inputs map[string]esc.Value, env_name string, context map[string]esc.Value) (esc.Value, error) {
...
func (testSchemaProvider) Open(ctx context.Context, inputs map[string]esc.Value, env_name string, context map[string]esc.Value) (esc.Value, error) {
